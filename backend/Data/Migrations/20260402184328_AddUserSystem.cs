...
namespace PriceTracker.Data.Migrations
{
    ...
    public partial class AddUserSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserProductLabel",
                columns: table => new
                {
                    LabelsId = table.Column<int>(type: "integer", nullable: false),
                    UserProductsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductLabel", x => new { x.LabelsId, x.UserProductsId });
                    table.ForeignKey(
                        name: "FK_UserProductLabel_Labels_LabelsId",
                        column: x => x.LabelsId,
                        principalTable: "Labels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProductLabel_UserProducts_UserProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProductLabel_UserProductsId",
                table: "UserProductLabel",
                column: "UserProductsId");
